...
async def addCCMD(ctx,args,nom,command,curseur):
    ...
    return createEmbed("Commande ajoutée","Nom : {0}\nContenu : {1}".format(nom,quote),0x220cc9,"{0} {1}".format(ctx.invoked_parents[0],ctx.invoked_with.lower()),ctx.guild)
...
async def editCCMD(ctx,args,nom,curseur):
    ...
    return createEmbed("Commande modifiée","Nom : {0}\nNouveau contenu : {1}".format(nom,quote),0x220cc9,"{0} {1}".format(ctx.invoked_parents[0],ctx.invoked_with.lower()),ctx.guild)
...
async def helpCCMD(ctx,args,nom,curseur):
    ...
    return createEmbed("Contenu d'aide modifié","Commande : {0}\nDescription : {1}".format(nom,quote),0x220cc9,"{0} {1}".format(ctx.invoked_parents[0],ctx.invoked_with.lower()),ctx.guild)
...
async def embedCCMD(ctx,nom,command,curseur):
    ...
    return createEmbed("Embed {0}activé".format(dictBool[bool(command["Embed"])]),"Commande : {0}".format(nom),0x220cc9,"{0} {1}".format(ctx.invoked_parents[0],ctx.invoked_with.lower()),ctx.guild)
...
async def authorCCMD(ctx,args,nom,curseur):
    ...
    return createEmbed("Auteur d'embed modifié","Commande : {0}\nAuteur : {1}".format(nom,author),0x220cc9,"{0} {1}".format(ctx.invoked_parents[0],ctx.invoked_with.lower()),ctx.guild)
...
async def titleCCMD(ctx,args,nom,curseur):
    ...
    return createEmbed("Titre d'embed modifié","Commande : {0}\nTitre : {1}".format(nom,titre),0x220cc9,"{0} {1}".format(ctx.invoked_parents[0],ctx.invoked_with.lower()),ctx.guild)
...
async def footerCCMD(ctx,args,nom,curseur):
    ...
    return createEmbed("Bas d'embed modifié","Commande : {0}\nBas de page : {1}".format(nom,footer),0x220cc9,"{0} {1}".format(ctx.invoked_parents[0],ctx.invoked_with.lower()),ctx.guild)
...
async def imageCCMD(ctx,args,nom,curseur,option):
    ...
    return createEmbed("{0} d'embed modifiée".format(option),"Commande : {0}\n{1} : {2}".format(nom,option,image),0x220cc9,"{0} {1}".format(ctx.invoked_parents[0],ctx.invoked_with.lower()),ctx.guild)
...
async def colorCCMD(ctx,args,nom,curseur):
    ...
    return createEmbed("Couleur d'embed modifiée","Commande : {0}\nCouleur : {1}".format(nom,args[1].lower()),0x220cc9,"{0} {1}".format(ctx.invoked_parents[0],ctx.invoked_with.lower()),ctx.guild)