...
def embedHelp30(option,guildOT,page,bot):
    ...
    if option=="home":
        embedHelp.description="Effectuez une de ces commandes pour avoir plus d'infos sur mes commandes !\n**Mon préfixe est OT!**\n[Invitez moi !](https://bit.ly/OlborTrack) - [Faites une donation !](https://paypal.me/OlborTrack) - [Serveur de test](https://discord.com/invite/kMQz7nF) - [Twitter](https://twitter.com/olbortrack) - [Instagram](https://www.instagram.com/OlborTrack/)"
        if page==1 or page==2:
            if guildOT!=None:
