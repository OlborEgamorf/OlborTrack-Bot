dictStats={1:[],2:["jour","mois","annee","global","count","perso","random","hideme","blindme"],3:["messages","messperiods","messevol","messjours","messroles"],4:["voice","voicperiods","voicevol","voicjours","voicroles"],5:["salons","saloserv","saloperiods","saloevol","saloperso","saloroles"],6:["freq","freqserv","freqperiods","freqevol","freqperso","freqroles"],7:["voicechans","vchaserv","vchaperiods","vchaevol","vchaperso","vcharoles"],8:["emotes","emotserv","emotperiods","emotevol","emotperso","emotroles"],9:["reactions","reacserv","reacperiods","reacevol","reacperso","reacroles"],10:["mots","motsperiods","motsevol","motsroles"],11:["divers","diveserv","diveperiods","diveperso","diveroles"],12:["mentions","mentperiods","mentperso","moyheure","moyjour","moymois","moyannee"],13:[],14:["messcompare","salocompare","voiccompare","motscompare","vchacompare","freqcompare","emotcompare","reaccompare"],15:["salocomprank","vchacomprank","freqcomprank","emotcomprank","reaccomprank"],16:["messcompserv","voiccompserv","motscompserv","salocompserv","vchacompserv","freqcompserv","emotcompserv","reaccompserv"],17:["salocompperso","vchacompperso","freqcompperso","emotcompperso","reaccompperso"]}

dictPoll={1:[],2:["poll","polltime"],3:["giveaway","gareroll"],4:["reminder"]}

dictOutils={1:[],2:["bienvenue","bienvenue chan","bvmessage","bvmessage add","bvmessage edit","bvmessage del","bvimage","bvimage add","bvimage edit","bvimage del"],3:["adieu","adieu chan","admessage","admessage add","admessage edit","admessage del","adimage","adimage add","adimage edit","adimage del"],4:["tableau","tableau add","tableau del","tableau nb","tableau chan"],5:["voiceephem add","voiceephem del","voiceephem limit","voiceephem edit","voiceephem hubs","voiceephem salons"],6:["customcmd","customcmd add","customcmd del","customcmd embed","customcmd patron","customcmd edit","customcmd auteur","customcmd titre","customcmd bas","customcmd image","customcmd miniature","customcmd couleur","customcmd len"],7:["auto","auto add","auto del","auto edit"]}

dictJeux={1:[],2:["trivial","trivialversus","trivialbr","trivialparty","trivialstreak"],3:["tortues","tortuesduo"],4:["p4","matrice","bataillenavale"],5:["jeuxrank","jeuxmondial","jeuxperso","jeuxboard","trivialrank","trivialperso"],6:["tortuescross","tortuesduocross","p4cross","trivialversuscross","trivialbrcross","trivialpartycross"]}
...
dictAutre={1:["help","about","invite","support","test","feedback","servcount","credits","reseaux","botlists"],2:["roulette","dice","snipe","avatar","say","perms"]}
...
dictPAlertes={1:"Olbor Track peut fournir des alertes liées à YouTube, Twitter et Twitch !\nDès que votre créateur préféré publie une nouvelle vidéo/un nouveau Tweet/un nouveau stream, un message est envoyé dans le salon de votre choix !\nPour les configurer, vous devez avoir la permission 'gestion des messages'."}
dictPAnniv={1:"Les anniversaires sont une fonctionnalité globale et cross-serveur.\nAjoutez votre date d'anniversaire dans le bot, et le jour venu dans les serveurs ayant activé la fonctionnalité et où vous êtes, un message sera envoyé !",3:"Ces commandes sont conçues pour les modérateurs des serveurs, pour leur permettre d'activer la fonctionnalité. Elles nécéssitent la permission 'gestion des messages'."}
...
dictFTitres={1:[],2:["usage"],3:["usage"],4:["usage"],5:["usage"]}

dictFInteract={1:[],2:["usage"],3:["mal","usage"],4:["usage"],5:[]}

dictFAlertes={1:[],2:["salons","usage"],3:["salons","usage"],4:["salons","usage"],5:["salons","usage"]}

dictFAnniv={1:[],2:["usage"],3:["usage"]}
...
dictFields={
    ...
    "trivial":{"name":"Catégories OT!Trivial","value":"culture / divertissement / sciences / mythologie / sport / géographie / histoire / politique / art / célébrités / animaux / véhicules\n*Catégories spéciales hors classements : livres / films / musique / anime / manga"}
    }

dictTStats={1:"Statistiques",2:"Commandes diverses",3:"Statistiques de messages",4:"Statistiques vocales",5:"Statistiques des salons",6:"Statistiques des heures d'activité",7:"Statistiques des salons vocaux",8:"Statistiques des emotes",9:"Statistiques des réactions",10:"Statistiques de mots envoyés",11:"Statistiques diverses",12:"Moyennes et mentions",13:"Graphiques animés",14:"Commandes de comparaisons",15:"Commandes de comparaisons",16:"Commandes de comparaisons",17:"Commandes de comparaisons"}
...
dictTJeux={1:"Jeux",2:"Jeux Trivial",3:"Jeux Tortues",4:"Autres jeux",5:"Classements",6:"Jeux Cross-Serveur"}
...
dictTTitres={1:"Titres et personnalisation",2:"Listes et équipement de titre",3:"Achat, vente et échange de titre",4:"Profil de joueur et options de personnalisation",5:"Options pour les serveurs"}
...
dictTAlertes={1:"Alertes YouTube/Twitch/Twitter",2:"YouTube",3:"Twitch",4:"Twitter",5:"Mises à jour Olbor Track"}

dictTAnniv={1:"Anniversaires",2:"Commandes pour les utilisateurs",3:"Commandes pour les modérateurs"}