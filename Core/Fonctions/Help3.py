...
dictPAdmin={1:"Les administrateurs du serveur peuvent configurer Olbor Track afin d'avoir une utilisation personnalisée du bot.\nIls peuvent moduler les statistiques traquées, les commandes activées, le statut des salons, et +...",4:"**OT!getdata** : initialise toutes les statistiques de votre serveur."}
dictPAutre={}

dictFStats={1:[],2:["periodes","usage"],3:["periodes","roles","usage"],4:["periodes","roles","usage"],5:["periodes","salons","roles","usage"],6:["periodes","heure","roles","usage"],7:["periodes","voice","roles","usage"],8:["periodes","emote","roles","usage"],9:["periodes","emote","roles","usage"],10:["periodes","roles","usage"],11:["periodes","divers","roles","usage"],12:["periodes","usage"],13:["périodes","usage"]}

dictFPoll={1:[],2:["temps","texte","usage"],3:["temps","gagnants","usage"],4:["temps","usage"]}

dictFOutils={1:[],2:["salon","usage"],3:["salon","usage"],4:["usage"],5:["salon","auto","usage"]}
...
dictFSpotify={1:["usage"],2:["usage"]}

dictFGeo={1:[],2:[]}

dictFAdmin={1:[],2:["salon","usage"],3:["usage"],4:["usage"],5:[]}
