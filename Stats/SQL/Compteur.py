...
def compteurSQL(base,table,id,insert,count,date,period,obj,evol,crea,baseGL):
    ...
    return rankingSQL(base,table,countB,countN,id,rank,date,period,obj,evol,baseGL)
...
def compteurTrivialS(id,insert,count):
    ...
    rankingSQL(curseur,"trivialStreak",countB,count,id,rank,None,None,None,None,None)
    connexion.commit()
