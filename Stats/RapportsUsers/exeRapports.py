...
async def rapportUser(interaction,periode,guildOT,bot):
    ...
    curseurCMD.execute("INSERT INTO commandes VALUES({0},{1},'rapportUser','{2}','Home','{3}','{4}','None',1,{5},'countDesc',False)".format(interaction.id,interaction.user.id,option,mois,annee,pagemax))
